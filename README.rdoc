...
По умолчанию используется идущий в комплекте модуль DeviseSmsConfirmable::Provider. Для дефолтного отправщика нужно заполнить следующие параметры:
...
логин и пароль на сервисе смс рассылок http://prostor-sms.ru/
